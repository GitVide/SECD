...
def get_token():
    ...
    data['client_id'] = 'FhRmh20HRsQW00Dq4S8SfK5f'  # 百度该应用的APP—ID
    data['client_secret'] = 'QMB5buaw9ZEVmuU6qgOwKjcqEbDREfZG'  # 相应的secret
...
def faceadd(face1, face2, image):
    ...
    data = {"image_template": {"image": base666(face1), "image_type": 'BASE64', "quality_control": "NORMAL", },
            "image_target": {"image": base666(face2), "image_type": "BASE64", "quality_control": "NORMAL", },
